...
path = '/home/thomas/Documents/KP_schmidt/230607_DLTM-ATtiny20-MI-Fullscans (copy)/3V3/rest/csv/20230606-124422_t.csv'
...
##valList2 = arr2[arr2 > 0]
##plt.hist(valList2, bins = 10, edgecolor = 'black')
##plt.xlabel('Values')
##plt.ylabel('Frequency')
##plt.title('Histogram of Values in Resized Array')
##plt.show()
##
##valList = arr[arr > 0]
##plt.hist(valList, bins = 10, edgecolor = 'black')
##plt.xlabel('Values')
##plt.ylabel('Frequency')
##plt.title('Histogram of Values in Original Array')
##plt.show()

arr2 = arr2.astype(int)
df = pd.DataFrame(arr2)
df.to_csv('TestBinning.csv', index = False, header = False, sep = ';')
