...
def BinningFactors(path1, path2):
    ...
    #calculate factors
    xFac = P2Width/P1Width
    yFac = P2Height/P1Height
...
##path2 = '/home/thomas/Documents/KP_schmidt/230607_DLTM-ATtiny20-MI-Fullscans (copy)/3V3/rest/panos/20230605-pano_thr.png'
